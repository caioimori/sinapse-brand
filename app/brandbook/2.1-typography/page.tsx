...
const SCALE = [
  ...
  { label: "H2", size: "clamp(1.75rem,4.5vw,3.25rem)", sizePx: "52 → 60px", weight: 300, text: "Um sistema construído pra escala.", line: "1", track: "-0.035em" },
    ...
    <main className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <section className="border-b border-border">
        <Container className="py-12 sm:py-16 md:py-20 lg:py-24">
          ...
          <h2 className="mt-4 font-display font-light text-[clamp(1.75rem,4.5vw,3.25rem)] leading-[1] tracking-[-0.035em] text-balance mb-12 md:mb-16">
