      ...
      <section className="border-b border-border">
        <Container className="py-12 sm:py-16 md:py-20 lg:py-24">
          ...
          <CornerBrackets className="block bg-card border border-border p-8 md:p-16 lg:p-20 min-h-[420px] flex flex-col justify-center">
            ...
            <h1 className="font-display font-light text-[clamp(3.25rem,8vw,6rem)] leading-[0.95] tracking-[-0.045em] max-w-[18ch]">
              Escale sem aumentar <span className="font-medium italic">a folha.</span>
            </h1>
            <p className="mt-6 max-w-[55ch] font-sans text-base md:text-lg opacity-65 leading-relaxed">
      ...
      <section className="border-b border-border bg-card">
        <Container className="py-16 md:py-24">
          <CornerBrackets className="bg-background border border-border p-10 md:p-16 text-center">
            ...
            <h2 className="font-display font-light text-[clamp(3.25rem,6vw,5rem)] leading-[0.95] tracking-[-0.04em] max-w-[18ch] mx-auto">
